...
export class SearchDropdownComponent implements OnInit, ControlValueAccessor {
  ...
  @Input()
  public set outerStyleClass(v: any) {
    this.selectClass = v;
  }

  public get outerStyleClass(): any {
    return this.selectClass;
  }

  @Input()
  public set innerStyleClass(v: any) {
    this.scrollClass = v;
  }

  public get innerStyleClass(): any {
  ...
  ngOnInit() {
    ...
    this.keyDowns.pipe(filter((e) => ((e.keyCode === KEY_CODE.arrowDown || e.keyCode === KEY_CODE.arrowUp)
    && !this.isListHide))).subscribe((e) => {
